...
class TeacherCourseController extends Controller
{
    ...
    public function update (Request $request, $teacher_id, $course_id) {
        ...
        return $this->createErrorResponse("The teacher with the id {$teacher_id} does not exist", 404);
    }
    ...
    public function destroy ($teacher_id, $course_id) {
        ...
        if ($teacher) {
            ...
            if ($course) {
                ...
                return $this->createErrorResponse("The course with the id {$course_id} is not associated with the teacher with id {$teacher_id}", 404);
            }
